...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PWSTR pCmdLine, int nCmdShow)
{
	...
	{
		-0.5f, 1.f, 1.f, 0.f, 0.f, -1.f, 0.0f, 0.f,					// top
		0.5f, -1.f, 1.f, 0.f, 0.f, -1.f, 1.f, 1.f,					// bottom right
		-0.5f, -1.f, 1.f, 0.f, 0.f, -1.f, 0.f, 1.f,					// bottom left

		-0.5f, 1.f, 1.f, 0.f, 0.f, -1.f, 0.f, 0.f,
		0.5f, 1.f, 1.f, 0.f, 0.f, -1.f, 1.f, 0.f,
		0.5f, -1.f, 1.f, 0.f, 0.f, -1.f, 1.f, 1.f
	};

	UINT vertex_stride = 8 * sizeof(float);		// DONT FORGET TO UPDATE STRIDE WHEN ADDING NEW THINGS!
	...
	/* Link ID3D11ShaderResourceView* to your pixel shader */
	...
	buf_desc_mov.BindFlags = D3D11_BIND_CONSTANT_BUFFER;
	buf_desc_mov.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;
	buf_desc_mov.MiscFlags = NULL;
	buf_desc_mov.StructureByteStride = 0;

	D3D11_BUFFER_DESC buf_desc_light;
	buf_desc_light.Usage = D3D11_USAGE_DYNAMIC;
	buf_desc_light.ByteWidth = sizeof(Light);
	buf_desc_light.BindFlags = D3D11_BIND_CONSTANT_BUFFER;
	buf_desc_light.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;
	buf_desc_light.MiscFlags = NULL;
	buf_desc_light.StructureByteStride = 0;

	hr = device_ptr->CreateBuffer(&buf_desc_mov, NULL, &const_buf_mov);
	...
	while (!closed)
	{
		...
		/* Update our constant buffers here */
		...
		//mov_ptr->move_mat = XMFLOAT4X4(
		//	cosf(time), -sinf(time), 0.f, 0.f,
		//	sinf(time), cosf(time), 0.f, 0.f,
		//	0.f, 0.f, 1.f, 0.f,
		//	0.f, 0.f, 0.f, 1.0f
		//);
		...
		light_ptr->light_pos = XMFLOAT3(sinf(time), 0.f, 0.1f);
