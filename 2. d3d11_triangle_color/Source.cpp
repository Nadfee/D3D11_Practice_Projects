...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PWSTR pCmdLine, int nCmdShow)
{
	...
	D3D11_INPUT_ELEMENT_DESC input_element_desc[] = {
		...
		/* ADDED */ {"COLOR", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_VERTEX_DATA, 0 }
		// D3D11_APPEND_ALIGNED_ELEMENT makes sure that the data read is right after the previous input element
	};
	...
	{
		0.0f, 0.5f, 0.f, 1.f, 0.f, 0.f,			// top
		0.5f, -0.5f, 0.f, 0.f, 1.f, 0.f,		// bottom right
		0.0f, -0.5f, 0.f, 0.f, 0.f, 1.f,		// bottom left
		0.1f, 0.5f, 0.f, 1.f, 0.f, 0.f,
		0.75f, 0.5f, 0.f, 0.f, 1.f, 0.f,
		0.6f, -0.5f, 0.f, 0.f, 0.f, 1.f
	};
